                        ...
                        <div class="mb-4">
                            <div class="card-body">
                                <div class="form-group">
                                    <input class="form-control contactInput" name="contactName"
                                        placeholder="Adınız Soyadınız">
                                </div>
                                <div class="form-group">
                                    <input class="form-control contactInput" name="contactEmail"
                                        placeholder="Mail Adresiniz">
                                </div>
                                <div class="form-group">
                                    <input class="form-control contactInput" name="contactTitle"
