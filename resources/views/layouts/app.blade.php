        ...
        <div class="container box_1620">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            ...
            <ul class="nav navbar-nav navbar-right navbar-social">
              <li><a href="https://www.facebook.com/people/Preprod-Dev/100089444574092/"><i class="ti-facebook"></i></a></li>
              <li><a href="https://twitter.com/PreprodDev"><i class="ti-twitter-alt"></i></a></li>
              <li><a href="https://www.instagram.com/preproddev/"><i class="ti-instagram"></i></a></li>
            </ul>
          </div>
        </div>
      </nav>
      ...
      <div class="row">
        <div class="col-lg-3  col-md-6 col-sm-6">
          <div class="single-footer-widget">
            <h6>Hakkımızda</h6>
            <p>
            Preprod-Dev<br><br> Programlama ve web teknolojileri öncelik olmak üzere farklı konularda yazılar içermektedir.
            </p>
          </div>
        </div>
