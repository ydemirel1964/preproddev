...
const lessons = [
    ...
    [
        ...
        "javascript-nedir-ne-icin-kullanilir"
    ],
    [
        "DOM nedir?",
        "dom-nedir"
    ...
    [
        "Laravel nedir? Ne için kullanılır?",
        "laravel-nedir"
    ],
    [
        "JAVA Nedir?",
...
document.getElementById('top-area').innerHTML ="<a href='"+lessons[0][1]+"'>"+lessons[0][0]+"</a>";
let lessonNumber =0;
setInterval(function () {
    lessonNumber = Math.floor(Math.random() * lessons.length);
